...
class CClawEffectLeft final : public CGameObject
{
private:
	CClawEffectLeft(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	virtual ~CClawEffectLeft() = default;
...
public:
	static  CClawEffectLeft* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
