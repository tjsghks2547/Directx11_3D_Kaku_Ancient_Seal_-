...
class CBoss_Right_Arm : public CGameObject
{
public:
	struct BODY_DESC
	{
...
private:
	CBoss_Right_Arm(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	virtual ~CBoss_Right_Arm() = default;	
...
public:
	static  CBoss_Right_Arm* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, void* pArg);
