...
class CSlashEffect2 final : public CGameObject
{
private:
	CSlashEffect2(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	virtual ~CSlashEffect2() = default;
...
public:
	static  CSlashEffect2* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
