...
CClawEffectLeft::CClawEffectLeft(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
    :CGameObject(pDevice, pContext)
{
}


HRESULT  CClawEffectLeft::Initialize(void* pArg)
{
    ...
    m_pTransformCom->Set_State(CTransform::STATE_POSITION, XMVectorSetX(m_pTransformCom->Get_State(CTransform::STATE_POSITION), (m_pTransformCom->Get_State(CTransform::STATE_POSITION).m128_f32[0] - 60.f)));
    ...
    m_pTransformCom->Set_State(CTransform::STATE_POSITION, XMVectorSetZ(m_pTransformCom->Get_State(CTransform::STATE_POSITION), (m_pTransformCom->Get_State(CTransform::STATE_POSITION).m128_f32[2] + 55.f)));
...
void  CClawEffectLeft::Priority_Update(_float fTimeDelta)
{
...
void  CClawEffectLeft::Update(_float fTimeDelta)
{
    __super::Update(fTimeDelta);

}

void  CClawEffectLeft::Late_Update(_float fTimeDelta)
{
...
HRESULT CClawEffectLeft::Render()
{
...
HRESULT CClawEffectLeft::Render_Blur()
{
    if (m_fAccTimeDelta > 0.3f)
    {
...
void CClawEffectLeft::OnCollisionEnter(CGameObject* _pOther)
{
}

void CClawEffectLeft::OnCollision(CGameObject* _pOther)
{
}

void CClawEffectLeft::OnCollisionExit(CGameObject* _pOther)
{
}

HRESULT CClawEffectLeft::Ready_Components()
{
    /* Com_Shader */
...
HRESULT CClawEffectLeft::Bind_ShaderResources()
{
...
CClawEffectLeft* CClawEffectLeft::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
    CClawEffectLeft* pInstance = new CClawEffectLeft(pDevice, pContext);

    if (FAILED(pInstance->Initialize(nullptr)))
    {
        MSG_BOX("Failed to Created : CClawEffectLeft");
...
CGameObject* CClawEffectLeft::Clone(void* pArg)
{
    return nullptr;
}

void CClawEffectLeft::Free()
{
    __super::Free();
