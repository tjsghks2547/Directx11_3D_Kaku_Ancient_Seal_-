#include "pch.h"    
#include "HitEffectX.h"   
#include "GameInstance.h"
#include "Shader.h"
#include "Client_Defines.h" 

CHitEffectX::CHitEffectX(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
    :CGameObject(pDevice, pContext)
{
}


HRESULT  CHitEffectX::Initialize(void* pArg)
{
...
void  CHitEffectX::Priority_Update(_float fTimeDelta)
{
...
void  CHitEffectX::Update(_float fTimeDelta)
{

}

void  CHitEffectX::Late_Update(_float fTimeDelta)
{
    /* 여기서 버퍼 업데이트 해줘야겠다. */
...
void CHitEffectX::OnCollisionEnter(CGameObject* _pOther)
{
}

void CHitEffectX::OnCollision(CGameObject* _pOther)
{
}

void CHitEffectX::OnCollisionExit(CGameObject* _pOther)
{
}

HRESULT CHitEffectX::Ready_Components()
{
    /* Com_Model */
...
HRESULT CHitEffectX::Bind_ShaderResources()
{
...
HRESULT CHitEffectX::Effect_Activate()
{
...
CHitEffectX* CHitEffectX::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
    CHitEffectX* pInstance = new CHitEffectX(pDevice, pContext);
...
CGameObject* CHitEffectX::Clone(void* pArg)
{
    return nullptr;
}

void CHitEffectX::Free()
{
    __super::Free();
